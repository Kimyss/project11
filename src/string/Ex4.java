...
public class Ex4 {
	...
	public static void main(String[] args) {
		...
		System.out.println("av라는 문자열 포함하는지 확인: " + str.contains("av"));
		System.out.println("ja라는 문자열 시작하는지 확인: "+ str.startsWith("ja"));
		System.out.println("va라는 문자열로 끝나는지 확인: " + str.endsWith("va"));
		...
		System.out.println("2번 위치부터 4번위치전까지 자르기: " + str.substring(2, 4));
